 ...
 *
 * This is where the four layers of the concept appear together on one screen,
  ...
  return (
    ...
    <div className="mx-auto max-w-2xl px-3 pt-3">
      ...
      <h1 className="mt-3 text-xl font-bold tracking-tight text-ink">
        {post.title ?? `Beitrag von ${post.author}`}
      </h1>
      <p className="mt-1 text-sm text-muted">
        Beitrag, Analyse, eigene Reaktion und Community-Reaktionen auf einer
        Seite.
      </p>

      {/* ---- 1. the content ----------------------------------------- */}
      {post.mode === 'discussion' ? (
        <div className="mt-4">
